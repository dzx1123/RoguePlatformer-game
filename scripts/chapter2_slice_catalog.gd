...
static func rooms() -> Array[Dictionary]:
	return [
		...
		{"id": &"forge_23", "chapter": 2, "number": 23, "title": "第一炉火", "layout": &"hall", "goal": &"clear", "enemies": [_enemy(&"ember_caster", Vector2(950, 450))], "heat": [], "heat_damage": false, "reward": &"gold", "hint": "熔火弹锁定落点后不再追踪；走开或换层即可躲避。"},
		...
		{"id": &"forge_25", "chapter": 2, "number": 25, "title": "炉口试炼", "layout": &"hall", "goal": &"clear", "enemies": [_enemy(&"ember_caster", Vector2(950, 450)), _enemy(&"basic", Vector2(660, 590), 560, 770), _enemy(&"basic", Vector2(1040, 590), 930, 1110)], "heat": [Rect2(380, 580, 110, 40), Rect2(780, 580, 110, 40)], "heat_damage": true, "reward": &"upgrade", "hint": "利用上下两条路线接近投掷者，清敌后选择一次强化。"},
	]
