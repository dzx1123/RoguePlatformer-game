...
The files in `combat_cc0/` are selected from **Kenney Impact Sounds** and
**Kenney RPG Audio**, both licensed CC0 1.0. Source:

- https://kenney.nl/assets/impact-sounds
- https://kenney.nl/assets/rpg-audio

The sword swings in `sword_cc0/` and the slime layers in `gore_cc0/` are
selected from **Swishes Sound Pack** and **RPG Sound Pack** by artisticdude,
licensed CC0 1.0. Sources:

- https://opengameart.org/content/swishes-sound-pack
- https://opengameart.org/content/rpg-sound-pack

The organic burst layers are **Squelching SFX [4]** by SoundDesignForYou,
**Blood Spatter_Squelch_Near_Mono** by _stubb, and **breakingneck** by
cinevid, all licensed CC0 1.0 on Freesound. Sources:

- https://freesound.org/people/SoundDesignForYou/sounds/649976/
